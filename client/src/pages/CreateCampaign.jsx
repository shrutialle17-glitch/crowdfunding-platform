    ...
    <div className="max-w-7xl mx-auto py-12 px-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 bg-surface p-8 rounded-3xl shadow-warm-md border border-border">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-background/50 p-6 rounded-2xl border border-border">
            <div className="flex flex-col gap-1.5">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm text-text-secondary">Show donors exactly how their money will be spent (must add up to 100%).</p>
