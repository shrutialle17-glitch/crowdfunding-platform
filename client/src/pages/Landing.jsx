  ...
  return (
    <div className="w-full">
      ...
      <section className="relative overflow-hidden py-16 sm:py-24 lg:py-32">
        ...
        />
        <div
          className="absolute inset-0 bg-surface/70 backdrop-blur-[2px] z-0 pointer-events-none"  
        />
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            Join thousands of verified creators and passionate donors making a
            real impact. 100% transparent, 100% secure.
          </motion.p>
          ...
          >
            ...
            <Link to="/explore">
              <Button
                variant="outline"
                className="w-full sm:w-auto px-8 py-4 text-lg bg-white"
              >
                Explore Causes
              </Button>
            </Link>
      ...
      <section className="py-24 bg-surface">
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <motion.div {...fadeUpParams}>
              ...
              <p className="text-text-secondary text-lg max-w-xl">
                Support the most popular causes capturing the community's
                attention right now.
              </p>
            </motion.div>
            <Link
              to="/explore"
              className="hidden sm:flex items-center gap-2 text-primary font-semibold hover:text-primary-hover transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {trending
              ? trending.slice(0, 3).map((campaign, idx) => (
                  <motion.div
                    key={campaign._id}
                    {...fadeUpParams}
              ...
              : // Skeletons
                [1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-96 bg-border/50 rounded-2xl animate-pulse"
                  />
                ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            >
              ...
              <p className="text-text-secondary">
                Create a campaign, set your goals, and explain exactly how the
            ...
            >
              ...
              <p className="text-text-secondary">
                Our Trust & Safety team reviews your KYC documents to ensure
                platform integrity and build donor trust.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-text-secondary">
                Receive donations, hit your milestones, and post updates to your
                supporters as you change the world.
              </p>
            </motion.div>
          </div>
        </div>
